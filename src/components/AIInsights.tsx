...
import { Brain, TrendingUp, DollarSign, Truck, ChartPie, ClipboardList } from "lucide-react";
...
const insights = [
  ...
  {
    icon: <ChartPie className="w-6 h-6 text-green-500" />,
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {insights.map((insight, index) => (
          ...
          >
            <Card className="p-6 bg-black/40 backdrop-blur-sm border-gray-800 hover:border-gray-700 transition-colors h-full hover:scale-105 duration-300">
